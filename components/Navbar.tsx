...
export default function Navbar() {
  ...
  return (
    <motion.header
      ...
      className={`fixed top-0 left-0 right-0  mx-auto z-50 backdrop-blur transition-all duration-300 $ {
      ...
      <AnimatePresence>
        {open && (
          <motion.div
            ...
            className="md:hidden overflow-hidden bg-[#09000b]/95 backdrop-blur-xl border-b border-white/6"
          >
